                        ...
                        if (a(t.options.functional))
                            return (function(t, e, n, o, a) {
                                ...
                                if (i(u))
                                    ...
                                    i(n.attrs) && Me(c, n.attrs),
                                        i(n.props) && Me(c, n.props)
                                var f = new je(n, c, a, o, t),
                                    d = s.render.call(null, f._c, f)
                                if (d instanceof ht)
                                    return De(d, n, f.parent, s)
                                if (Array.isArray(d)) {
                                    for (
                                        var p = ue(d) || [],
                ...
                if (!o(t.data.domProps) || !o(e.data.domProps)) {
                    ...
                    for (n in c) {
                        ...
                        if ('value' === n && 'PROGRESS' !== a.tagName) {
                            ...
                            ;(kr =
                                kr || document.createElement('div')).innerHTML =
                                '<svg>' + r + '</svg>'
            ...
            function qr(t) {
                if (t) {
                    if ('object' == typeof t) {
                        var e = {}
                        return (
                            !1 !== t.css && T(e, Kr(t.name || 'v')), T(e, t), e
                        )
                    }
                            ...
                            i.key =
                                null == i.key
                                    ...
                                    ? 0 === String(i.key).indexOf(a)
                                        ...
                                        : a + i.key
                                    : i.key
                            var c = ((i.data || (i.data = {})).transition = To(
                                    this
                                )),
                                u = this._vnode,
                                l = So(u)
    ...
    function(t, e, n) {
        ...
        var r = n(1),
            ...
            function() {
                ...
                return (this._self._c || t)('h1', [
                    this._v('THE MAIN COMPONENT')
                ])
            })
        o._withStripped = !0
